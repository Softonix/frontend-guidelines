...
declare global {
  ...
  const useAuthService: typeof import('../src/views/auth/auth.service')['useAuthService']
  ...
  const useExampleViewService: typeof import('../src/views/example-view/example-view.service')['useExampleViewService']
